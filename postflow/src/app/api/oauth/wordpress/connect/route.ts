...
import { buildWordPressOAuthUrl } from "@/lib/auth/wordpress-oauth";
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const oauthUrl = buildWordPressOAuthUrl(state);
    ...
    oauthLogger.error({ err }, `WordPress connect error: ${message}`);
