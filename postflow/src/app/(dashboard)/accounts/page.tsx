...
export default async function AccountsPage({
  ...
  return (
    <div className="flex flex-col gap-8 p-8">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Connect your Nostr identity using your private key (nsec or
                  hex) to publish notes to any relay network.
                </CardDescription>
              </div>
              <a
                href="/accounts/nostr-connect"
                className="inline-flex items-center justify-center rounded-md bg-violet-600 px-4 py-2 text-sm font-medium text-white hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2"
              >
                {hasNostr ? "Reconnect Nostr" : "Connect Nostr"}
              </a>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 sm:grid-cols-1">
              <PlatformStatus name="Nostr" connected={hasNostr} />
            </div>
          </CardContent>
        </Card>
      )}
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Connect your Hashnode account using a personal access token to
                  publish articles to your Hashnode blog.
                </CardDescription>
              </div>
              <a
                href="/accounts/hashnode-connect"
                className="inline-flex items-center justify-center rounded-md bg-[#2962FF] px-4 py-2 text-sm font-medium text-white hover:bg-[#1E4FD8] focus:outline-none focus:ring-2 focus:ring-[#2962FF] focus:ring-offset-2"
              >
                {hasHashnode ? "Reconnect Hashnode" : "Connect Hashnode"}
              </a>
            </div>
          </CardHeader>
          <CardContent>
      ...
      {/* Pixelfed connection card */}
      {pixelfedEnabled && (
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Pixelfed</CardTitle>
                <CardDescription>
                  Connect your Pixelfed account to publish text and image posts
                  via the Mastodon-compatible API. Supports any Pixelfed instance.
                </CardDescription>
              </div>
              <a
                href="/accounts/pixelfed-connect"
                className="inline-flex items-center justify-center rounded-md bg-[#0170D9] px-4 py-2 text-sm font-medium text-white hover:bg-[#015BB5] focus:outline-none focus:ring-2 focus:ring-[#0170D9] focus:ring-offset-2"
              >
                {hasPixelfed ? "Reconnect Pixelfed" : "Connect Pixelfed"}
              </a>
            </div>
          </CardHeader>
          <CardContent>
